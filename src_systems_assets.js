...
window.AssetManager = {
    ...
    prefabs: {
        ...
        'Camp Storage Cache': { type: 'structure', category: 'terrain', radius: 1.2, height: 1.2, modelScale: 1.0, color: 0x5a4230, isObstacle: true, playerBuildable: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Camp Farm Plot': { type: 'structure', category: 'terrain', radius: 3, height: 0.4, modelScale: 1.0, color: 0x53613a, isObstacle: true, playerBuildable: true, farm: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        ...
        'Fern_Cluster': { type: 'structure', category: 'terrain', radius: 1.5, height: 0.8, modelScale: 1.0, color: 0x3a5a3a, isObstacle: false, decorative: true, habitat: 'darkForest', customModel: 'Procedural_Fern_Cluster', animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
