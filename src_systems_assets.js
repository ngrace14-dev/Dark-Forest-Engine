...
window.AssetManager = {
    ...
    prefabs: {
        ...
        'Female Dark Steel Boots': { type: 'armor', category: 'characters', radius: 0.5, height: 1.1, modelScale: 1.0, color: 0x24272d, faction: 'player', playerCompatible: true, armorSlot: 'legs', customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Sparks' } },
        'Female Dark Steel Gloves': { type: 'armor', category: 'characters', radius: 0.5, height: 0.8, modelScale: 1.0, color: 0x24272d, faction: 'player', playerCompatible: true, armorSlot: 'hands', customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Sparks' } },
        'Female Dark Steel Helm Cloak': { type: 'armor', category: 'characters', radius: 0.5, height: 2.2, modelScale: 1.0, color: 0x1f2228, faction: 'player', playerCompatible: true, armorSlot: 'head', customModel: null, animMap: {}, vfx: { aura: 'Void', onHit: 'Sparks' } },
        ...
        'Flesh Horror': { type: 'npc', category: 'npcs', radius: 0.8, height: 3.2, modelScale: 1.0, color: 0x7f1d3a, faction: 'forest', behavior: 'wander_aggro', speed: 2.7, role: 'forestHorror', customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'Void', onHit: 'Blood' } },
        ...
        'Dark Forest Boss': { type: 'npc', category: 'npcs', radius: 1.4, height: 4.5, modelScale: 1.0, color: 0x4c0519, faction: 'forest', behavior: 'wander_aggro', speed: 2.4, hp: 500, role: 'randomEncounterBoss', boss: true, encounterType: 'random', customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'Void', onHit: 'Blood' } },
        'Sand Reaver': { type: 'npc', category: 'npcs', radius: 1.6, height: 4, modelScale: 1.0, color: 0xc28a45, faction: 'monster', behavior: 'wander_aggro', speed: 3.2, hp: 7500, armor: 20, attackDamage: 70, role: 'duneGuardian', boss: true, encounterType: 'duneEntry', habitat: 'desert', customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'Fire', onHit: 'Sparks' } },
        'Swamp Siren': { type: 'npc', category: 'npcs', radius: 0.7, height: 2.4, modelScale: 1.0, color: 0x64704b, faction: 'forest', gender: 'female', behavior: 'wander_aggro', speed: 2.9, hp: 180, role: 'swampAmbusher', habitat: 'swamp', lureTargets: 'male', lureRadius: 24, customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'Void', onHit: 'Blood' } },
        'Slender Woman': { type: 'npc', category: 'npcs', radius: 0.7, height: 2.8, modelScale: 1.0, color: 0x171717, faction: 'forest', gender: 'female', behavior: 'wander_aggro', speed: 3.1, hp: 220, role: 'folkloreStalker', habitat: 'darkForest', customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'Void', onHit: 'Blood' } },
        'Hollow Root Forest Tunnel': { type: 'structure', category: 'terrain', radius: 4.5, height: 4, modelScale: 1.0, color: 0x59634c, isObstacle: false, accessible: true, tunnel: true, habitat: 'darkForest', customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Concealing Dead Brush': { type: 'structure', category: 'terrain', radius: 4, height: 3, modelScale: 1.0, color: 0x59605a, isObstacle: false, concealment: true, hideRadius: 4, habitat: 'darkForest', customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Rootbound Forest Monument': { type: 'structure', category: 'terrain', radius: 3.5, height: 5, modelScale: 1.0, color: 0x5b5a4d, isObstacle: true, landmark: true, habitat: 'darkForest', customModel: null, animMap: {}, vfx: { aura: 'Void', onHit: 'Dust' } },
        'Forest Walkway': { type: 'structure', category: 'terrain', radius: 5, height: 0.6, modelScale: 1.0, color: 0x3f4a36, isObstacle: true, walkway: true, habitat: 'darkForest', customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Moss-Covered Log': { type: 'structure', category: 'terrain', radius: 1.8, height: 1.5, modelScale: 1.0, color: 0x46533b, isObstacle: true, habitat: 'darkForest', customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Skeletal Beast Remains': { type: 'structure', category: 'terrain', radius: 3.5, height: 2.5, modelScale: 1.0, color: 0xb8a47c, isObstacle: true, habitat: 'darkForest', landmark: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Hanging Root Vines': { type: 'structure', category: 'terrain', radius: 4, height: 4, modelScale: 1.0, color: 0x35463c, isObstacle: false, decorative: true, hanging: true, habitat: 'darkForest', customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Fern Stealth Thicket': { type: 'structure', category: 'terrain', radius: 3.5, height: 2.5, modelScale: 1.0, color: 0x2f6b42, isObstacle: false, decorative: true, concealment: true, hideRadius: 3.5, habitat: 'darkForest', customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Leaf Pile': { type: 'structure', category: 'terrain', radius: 2.8, height: 1.5, modelScale: 1.0, color: 0x30352a, isObstacle: false, decorative: true, habitat: 'darkForest', customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Abandoned Wagon': { type: 'structure', category: 'terrain', radius: 3, height: 2.5, modelScale: 1.0, color: 0x4f4034, isObstacle: true, abandoned: true, roadside: true, habitat: 'darkForest', customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Guard': { type: 'npc', category: 'npcs', radius: 0.5, height: 2.1, modelScale: 1.0, color: 0x2563eb, faction: 'village', gender: 'male', behavior: 'patrol', speed: 2.5, customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'None', onHit: 'Blood' } },
        'Female Guard': { type: 'npc', category: 'npcs', radius: 0.5, height: 2.0, modelScale: 1.0, color: 0x2563eb, faction: 'village', behavior: 'patrol', speed: 2.5, playerCompatible: true, customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'None', onHit: 'Blood' } },
        'City Guard': { type: 'npc', category: 'npcs', radius: 0.5, height: 2.1, modelScale: 1.0, color: 0x64748b, faction: 'village', behavior: 'patrol', speed: 2.8, playerCompatible: true, customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'None', onHit: 'Blood' } },
        'Village Guard': { type: 'npc', category: 'npcs', radius: 0.5, height: 2.0, modelScale: 1.0, color: 0x2563eb, faction: 'village', behavior: 'patrol', speed: 2.5, playerCompatible: true, customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'None', onHit: 'Blood' } },
        'City Scout': { type: 'npc', category: 'npcs', radius: 0.5, height: 2.0, modelScale: 1.0, color: 0x38bdf8, faction: 'village', behavior: 'scout', speed: 4.2, playerCompatible: true, customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'None', onHit: 'Blood' } },
        'Village Scout': { type: 'npc', category: 'npcs', radius: 0.5, height: 1.9, modelScale: 1.0, color: 0x22c55e, faction: 'village', behavior: 'scout', speed: 3.8, playerCompatible: true, customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'None', onHit: 'Blood' } },
        'Adventurer': { type: 'npc', category: 'npcs', radius: 0.5, height: 1.9, modelScale: 1.0, color: 0x10b981, faction: 'adventurer', gender: 'male', behavior: 'questing', speed: 3.5, customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'None', onHit: 'Blood' } },
        'Female Adventurer': { type: 'npc', category: 'npcs', radius: 0.5, height: 1.85, modelScale: 1.0, color: 0x10b981, faction: 'adventurer', behavior: 'questing', speed: 3.5, playerCompatible: true, customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'None', onHit: 'Blood' } },
        'Noble NPC': { type: 'npc', category: 'npcs', radius: 0.5, height: 1.9, modelScale: 1.0, color: 0xf1d38a, faction: 'village', behavior: 'patrol', speed: 1.8, role: 'noble', customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'Holy', onHit: 'Blood' } },
        'Tech Adventurer': { type: 'npc', category: 'npcs', radius: 0.5, height: 1.85, modelScale: 1.0, color: 0x38bdf8, faction: 'adventurer', behavior: 'questing', speed: 3.8, role: 'techSpecialist', customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'None', onHit: 'Sparks' } },
        'Merchant Caravan': { type: 'npc', category: 'npcs', radius: 1.2, height: 2.4, modelScale: 1.0, color: 0x8b6b43, faction: 'village', behavior: 'caravan', speed: 4, hp: 180, role: 'merchantCaravan', customModel: null, animMap: { idle: 'None', walk: 'None', attack: 'None', block: 'None', dash: 'None', hit: 'None', die: 'None' }, vfx: { aura: 'None', onHit: 'Dust' } },
        ...
        'Razor Rock Monolith': { type: 'mountain', category: 'terrain', radius: 5, height: 18, modelScale: 1.0, color: 0x414754, isObstacle: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Sparks' } },
        'Jagged Rock Wall Section': { type: 'structure', category: 'terrain', radius: 6, height: 10, modelScale: 1.0, color: 0x50535a, isObstacle: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Sparks' } },
        'Collapsed Tomb Entrance': { type: 'structure', category: 'terrain', radius: 4, height: 6, modelScale: 1.0, color: 0x4b4f58, isObstacle: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Stone Shelving': { type: 'structure', category: 'terrain', radius: 2.5, height: 3.5, modelScale: 1.0, color: 0x5a5d66, isObstacle: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Rubble Rock Pile': { type: 'structure', category: 'terrain', radius: 4.5, height: 3.5, modelScale: 1.0, color: 0x555861, isObstacle: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        ...
        'Plague Doctor Merchant House': { type: 'structure', category: 'terrain', radius: 7, height: 8, modelScale: 1.0, color: 0x30383a, isObstacle: true, merchantInterior: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Watertight Gothic House': { type: 'structure', category: 'terrain', radius: 7, height: 8, modelScale: 1.0, color: 0x343d3d, isObstacle: true, watertight: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Armorer Open Forge': { type: 'structure', category: 'terrain', radius: 7, height: 7, modelScale: 1.0, color: 0x3b4148, isObstacle: true, openAir: true, merchantType: 'armorer', forge: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Sparks' } },
        'Plague Carrier Treatment Center': { type: 'structure', category: 'terrain', radius: 8, height: 6, modelScale: 1.0, color: 0x756b58, isObstacle: true, openAir: true, accessible: true, serviceType: 'plagueTreatment', merchantType: 'plagueCarrier', customModel: null, animMap: {}, vfx: { aura: 'Holy', onHit: 'Dust' } },
        'City Street Building Facade': { type: 'structure', category: 'terrain', radius: 6, height: 8, modelScale: 1.0, color: 0x5c5f63, isObstacle: true, facade: true, urban: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Run-Down Water Mill': { type: 'structure', category: 'terrain', radius: 7, height: 7, modelScale: 1.0, color: 0x4f5148, isObstacle: true, abandoned: true, waterMill: true, villageExterior: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Dust' } },
        'Twisted Gothic Castle': { type: 'structure', category: 'terrain', radius: 14, height: 18, modelScale: 1.0, color: 0x34495a, isObstacle: true, landmark: true, fortified: true, customModel: null, animMap: {}, vfx: { aura: 'Void', onHit: 'Sparks' } },
        'Gothic Vault Door': { type: 'structure', category: 'terrain', radius: 3.5, height: 5, modelScale: 1.0, color: 0x2b2525, isObstacle: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Sparks' } },
        'Tentacled Gothic Door': { type: 'structure', category: 'terrain', radius: 3.5, height: 5.5, modelScale: 1.0, color: 0x263b45, isObstacle: true, gatherable: 'flesh_pods', gatherCooldown: 20, gatherAmount: 1, touchEffect: 'Poison', touchRadius: 5, touchCooldown: 4, customModel: null, animMap: {}, vfx: { aura: 'Void', onHit: 'Blood' } },
        'Floating Power Stone': { type: 'powerStone', category: 'terrain', radius: 2, height: 5, modelScale: 1.0, color: 0x334155, isObstacle: true, active: true, barrierRadius: 22, customModel: null, animMap: {}, vfx: { aura: 'Holy', onHit: 'Sparks' } },
        'Iron Fire Pit': { type: 'firePit', category: 'terrain', radius: 1.5, height: 1.2, modelScale: 1.0, color: 0x292929, isObstacle: true, active: true, emitsLight: true, customModel: null, animMap: {}, vfx: { aura: 'Fire', onHit: 'Sparks' } },
        'Floating Street Light': { type: 'streetLight', category: 'terrain', radius: 0.45, height: 4, modelScale: 1.0, color: 0x263344, isObstacle: true, active: true, emitsLight: true, customModel: null, animMap: {}, vfx: { aura: 'None', onHit: 'Sparks' } },
            ...
            btn.addEventListener('click', (e) => {
                ...
                if (window.AssetManager.prefabs[pName]) {
                    ...
                    if (def.type === 'character' || def.type === 'npc') {
                        const modelMeta = window.AssetManager.modelMeta[def.customModel];
                        def.animationReady = Boolean(modelMeta && modelMeta.rigged && modelMeta.hasAnimations);
                        if (def.customModel && !def.animationReady) window.EventBus.emit('UI_LOG', `Warning: ${def.customModel} needs a rig and animation clips for ${pName}.`);
                    }
